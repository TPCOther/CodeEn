...
# 讲utils的路径加入到环境变量中
INS = "Bug-Fixing task: give you a buggy function, try to fix the buggy function."
...
def read_examples(dataset: dict):
    ...
    bug = dataset['bug']
    fix = dataset['fix']
    assert len(bug) == len(fix)
    for idx, obj in enumerate(zip(bug, fix)):
        code, nl = obj
        code = code.replace('\n', ' ').strip()
        nl = nl.replace('\n', '').strip()
...
def main(model_name, cuda, mode: str, BEAM_SIZE=5, model_type="t5"):
    ...
    config = {
        'train': "/home/yanmeng/huangnaiqi/Assertion/Dataset/NBFs/train.json",
        'test': "/home/yanmeng/huangnaiqi/Assertion/Dataset/NBFs/test.json",
        'valid': "/home/yanmeng/huangnaiqi/Assertion/Dataset/NBFs/valid.json",
    }
    ...
    for i in tqdm(range(0, len(dataset), batch_size)):
        ...
        if model_type == "t5":
            ...
            inputs = tokenizer(dataset[i:i + batch_size]["bug"],
            ...
            input_data = [
                ...
                for input in dataset[i:i + batch_size]["bug"]
            ]
    ...
    if mode == "train":
        ...
        for i, item in enumerate(
                zip(dataset[:]["fix"], object_lists, ppl, only)):
        ...
        print("Acc.", correct_count / len(ppl))
...
if __name__ == "__main__":
    ...
    # main(
    #     model_name="/data/huangnaiqi/Assertion/outputs/BFs/Unixcoder/checkpoint-2/pytorch_model.bin",
    #     cuda=0,
    #     mode="valid",
    #     model_type="unix",
    #     BEAM_SIZE=10)

    # main(model_name="/data/huangnaiqi/Assertion/outputs/NBFs/CodeT5/checkpoint-2324",
    #      cuda=0,
    #      mode="train",
    #      model_type="t5",
    #      BEAM_SIZE=10)

    main(model_name="/home/yanmeng/huangnaiqi/Assertion/outputs/NBFs/CodeT5/checkpoint-2324",
         cuda=0,
         mode="test",
         model_type="t5",
         BEAM_SIZE=10)
    ...
    # main(
    # model_name=
    # "/home/yanmeng/huangnaiqi/Assertion/outputs/NBFs/CodeGen/checkpoint-9293",
    # cuda=1,
    # mode="test",
    # model_type="codegen",
    # BEAM_SIZE=10)
