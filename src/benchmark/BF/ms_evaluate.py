...
def main(model_name, cuda, mode: str, BEAM_SIZE=5, model_type="t5"):
    ...
    config = {
        'train': "/data/swf/Assertion/Dataset/BFs/train.json",
        'test': "/data/swf/Assertion/Dataset/BFs/test.json",
        'valid': "/data/swf/Assertion/Dataset/BFs/valid.json",
    }
    ...
    file_path = file_prefix + "/" + model_type + "_" + str(
        BEAM_SIZE) + "_" + file_name + ".rank.jsonl"
...
if __name__ == "__main__":
    ...
    # main(
    #     model_name="/data/swf/Assertion/outputs/BFs/Unixcoder/checkpoint-2/pytorch_model.bin",
    #     cuda=0,
    #     mode="valid",
    #     model_type="unix",
    #     BEAM_SIZE=10)

    # main(model_name="/data/swf/Assertion/outputs/BFs/CodeT5/checkpoint-5836",
    #      cuda=0,
    #      mode="valid",
    #      model_type="t5",
    #      BEAM_SIZE=10)
    ...
    main(
    model_name=
    "/data/swf/Assertion/outputs/BFs/CodeGen/checkpoint-17505",
    cuda=0,
    mode="valid",
    model_type="codegen",
    BEAM_SIZE=10)
