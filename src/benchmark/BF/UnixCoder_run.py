...
if __name__ == "__main__":
    '''
    # Training
    CUDA_VISIBLE_DEVICES=2 python /data/swf/Assertion/src/benchmark/BF/UnixCoder_run.py \
	--do_train \
	--do_eval \
	--model_name_or_path /data/swf/Assertion/Unixcoder-base/snapshots/727b99cf2a9cab12f417ac638ecd7c9242e896bf \
	--train_filename Dataset/BFs/train.json \
	--dev_filename Dataset/BFs/valid.json \
	--output_dir /data/swf/Assertion/outputs/BFs/Unixcoder \
