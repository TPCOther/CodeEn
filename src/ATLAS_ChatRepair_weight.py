    ...
    def metric_2(self, dataset_type, weight=True):
        ...
        for t in tqdm(datasets):
            ...
            if weight:
                ...
                jarcard_sim.append(assert_not_sim)
    ...
    def metric_3(self, dataset_type, hidden_states, train_hidden_states, weight=True):
        ...
        for index, t in tqdm(enumerate(datasets)):
            ...
            if weight:
                ...
                seman_sim_scores.append(assert_not_sim)
...
if __name__ == "__main__":
    ...
    for model_under_test, abstract in map_dic.items():    
        ...
        for prediction_model in ["combined"]:
            experiment.generate_final_result(model=chat_model, mode=repair_mode, prediction_mode=prediction_model, method="no_weight_s")
    ...
    with open(result_dir + f"Ablation_weight_results.txt", "w") as writer:
