...
import ATLAS_models
from ATLAS_prompt_construction import OpenAIClientSingleton, assertion_gen_demo_prompt, assertion_gen_system_prompt, assertion_gen_user_prompt, assertion_get_whether_repair_prompt, assertion_get_zero_shot_prompt, assertion_get_zero_shot_prompt_repair, assertion_repair_demo_prompt, check_assertion_prompt, regen_demo_assertion_prompt,vLLMClientSingleton
...
def agent_loop(prompt, line_indexs, templates, mode, model, n, temperture, ts: ATLAS_models.ATLAS_Datapoint):
    ...
    while k < max_repair:
        ...
        check_prompt = check_assertion_prompt(code_target, pred_target)
        responses = vLLMClientSingleton.get_response(
        ...
        fix_prompt = regen_demo_assertion_prompt(prompt_target, pred_target)
    ...
    for i in range(len(prompt)):
        final_results.append({
            ...
            "prompt": prompt[i],
            "gold": ts[i].assertion,
            "focal_method": ts[i].focal_method,
            "test_prefix": ts[i].test_method,
...
if __name__ == "__main__":
    ...
    BEAM_SIZE = 10
    seed = 42
    result_dir = "./outputs/ATLAS_LOU_agent/"
