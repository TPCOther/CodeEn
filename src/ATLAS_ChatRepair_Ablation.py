...
from dataset.atlas_dataset import AtlasDataset, AtlasPrompt, build_atlas_assertion_promp_jarcard, build_atlas_assertion_prompt_bm25, process_query, process_query_vocab, build_vocab
...
class ModelTester():
    ...
    def RFE_Feature_Selection(self):
        ...
        valid_metric4_file = self.result_dir + f"{model_under_test}_valid_metric4.npy"
...
if __name__ == "__main__":
    ...
    BEAM_SIZE = 10
    seed = 42
    result_dir = "./outputs/ATLAS_LOU/Ablation/"
